...
public class MainActivity extends AppCompatActivity {
    ...
    //as our api is having highest limit as 2 so we are setting a limit = 2
    int page = 0, limit = 2;
        ...
        nestedSV.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener() {
            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                ...
                if (scrollY == v.getChildAt(0).getMeasuredHeight() - v.getMeasuredHeight()) {
                    //in this method we are incrementing page number, making progress bar visible and calling get data method.
                    page++;
    ...
    private void getDataFromAPI(int page, int limit) {
        ...
        //calling a request queue method and passing our json object
